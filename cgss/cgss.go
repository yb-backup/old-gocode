...
func Login(args []string) int {
	...
	if err != nil {
		fmt.Println("Invalied Paramter: <level> should be an integer.")
		return 0
	}

	exp, err := strconv.Atoi(args[3])
	if err != nil {
		fmt.Println("Invalied Paramter: <exp> should be an integer")
		return 0
	}
	...
	err = centerClient.AddPayer(player)
	if err != nil {
